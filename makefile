Main.exe		: 	Main.o  transform.o AstarSearch.o LPAstar.o gridworld.o graphics.o 
	g++ -Wl,-s -o Main.exe Main.o transform.o AstarSearch.o LPAstar.o gridworld.o graphics.o -l gdi32 
